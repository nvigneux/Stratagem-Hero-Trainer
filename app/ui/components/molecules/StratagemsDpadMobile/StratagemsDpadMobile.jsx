...
function StratagemsDpadMobile() {
  return (
    <div className={styles.dpadContainer}>
      <StratagemsDpadMobile.Button keyName="up" keydownEvent={{ code: 'ArrowUp' }}>
        <Picto icon="arrow" className={cn([styles.icon, styles.up])} />
      </StratagemsDpadMobile.Button>
      <StratagemsDpadMobile.Button keyName="left" keydownEvent={{ code: 'ArrowLeft' }}>
        <Picto icon="arrow" className={cn([styles.icon, styles.left])} />
      </StratagemsDpadMobile.Button>
      <StratagemsDpadMobile.Button keyName="down" keydownEvent={{ code: 'ArrowDown' }}>
        <Picto icon="arrow" className={cn([styles.icon, styles.down])} />
      </StratagemsDpadMobile.Button>
      <StratagemsDpadMobile.Button keyName="right" keydownEvent={{ code: 'ArrowRight' }}>
